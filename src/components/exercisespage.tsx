...
//                 {/* SIR: added minHeight to prevent jitter */}
//             {/* <div className="ex-page-container" style={{ flex: 1, padding: "20px" }}> */}
...
import React, { useState, useEffect } from 'react';
import { Button } from 'react-bootstrap';
// import { isDisabled } from '@testing-library/user-event/dist/utils'; // This was unused in your file
